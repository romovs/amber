...
public class Textlog extends Widget {
    ...
    static RichText.Foundry fnd = new RichText.Foundry(TextAttribute.FAMILY, Config.font, TextAttribute.SIZE, Config.fontsizeglobal, TextAttribute.FOREGROUND, Color.BLACK);
    List<Text> lines;
    int maxy, cury;
    int margin = 3;
    UI.Grab sdrag = null;
